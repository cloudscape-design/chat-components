...
import { createRef, RefAttributes } from "react";
...
vi.mock("@cloudscape-design/component-toolkit", async () => ({
  ...(await vi.importActual("@cloudscape-design/component-toolkit")),
  useContainerQuery: () => [800, () => {}],
}));

const renderPromptInput = (promptInputProps: PromptInputProps & RefAttributes<HTMLTextAreaElement>) => {
...
describe("prompt input in form", () => {
  ...
  test("should submit the form when clicking the action button", () => {
    ...
    expect(console.error).toHaveBeenCalledWith(
      expect.stringContaining("Not implemented: HTMLFormElement.prototype.requestSubmit"),
      undefined,
    );
